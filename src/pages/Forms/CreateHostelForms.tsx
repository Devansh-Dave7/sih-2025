...
const CreateHostelForms: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        alert('Hostel form created successfully!');
        navigate('/dashboard');
      } else {
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
            <h3 className="font-medium text-black dark:text-white">
              Hostel Form Configuration
            </h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Create forms for hostel complaints, maintenance requests, and room changes
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5.5 p-6.5">
            ...
            <div className="flex gap-4 pt-4 border-t border-stroke dark:border-strokedark">
              ...
              >
                {isLoading ? 'Creating...' : 'Create Hostel Form'}
              </button>
              <button
                type="button"
...
export default CreateHostelForms;
