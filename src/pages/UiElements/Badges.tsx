...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | SPREADVERSE - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for SPREADVERSE - React.js Tailwind CSS Admin Dashboard Template"
      />
