...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | SPREADVERSE - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for SPREADVERSE - React.js Tailwind CSS Admin Dashboard Template"
      />
